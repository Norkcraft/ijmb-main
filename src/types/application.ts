export interface Application {
  ...
  // Academic Info
  olevel_exam_type: string | null;
  olevel_exam_year: string | null;
  olevel_exam_number: string | null;
  olevel_status: string | null;
  ...
  olevel_path: string | null;
  admission_letter_path: string | null;
  
  // Status & Fees
  status: 'draft' | 'submitted' | 'payment_pending' | 'payment_completed' | 'review' | 'admitted' | 'fees_pending' | 'active' | 'rejected';
  form_fee_paid: boolean;
  
  // New Fee Columns
  hostel_needed: boolean;
  tuition_payment_status: 'pending' | 'part_paid' | 'fully_paid';
...
export const STATES_OF_NIGERIA = [
...
export const NIGERIA_DATA: Record<string, string[]> = {
...
export const OLEVEL_SUBJECTS = [
  ...
  "Agricultural Science", "Economics", "Government", "Geography", 
  "Literature in English", "Accounting", "Commerce", "CRS", 
  "Islamic Studies", "Civic Education", "Computer Studies", 
  "Hausa", "Yoruba", "Igbo", "Further Mathematics", "History"
];
...
export const UNIVERSITY_COURSES = [
  "Medicine", "Pharmacy", "Engineering", "Computer Science", 
  "Accounting", "Business Administration", "Economics", 
  "Law", "Mass Communication", "Political Science", 
  "International Relations", "Biochemistry", "Microbiology",
  "Nursing Science", "Architecture", "Building Technology"
];
