...
const allFaqs = [
  ...
  { question: "How do I pay for IJMB registration?", answer: "You can pay the ₦5,500 registration form fee online through our portal. Programme fees are paid directly to your chosen study centre." },
...
const FAQPage = () => (
  <>
    <SEOHead
      title="IJMB FAQ – Your Questions About IJMB Answered"
      description="Comprehensive FAQ about IJMB registration, requirements, fees, centres, and admission. Get all your IJMB questions answered."
      canonical="https://www.ijmb.info/faq"
    />
