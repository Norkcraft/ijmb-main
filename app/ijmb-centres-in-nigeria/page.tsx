...
export const metadata: Metadata = {
  title: 'IJMB Study Centres in Nigeria 2026/2027 – Accredited List by State',
  ...
  openGraph: {
    title: 'IJMB Study Centres in Nigeria 2026/2027 – Accredited List',
  ...
  twitter: {
    ...
    title: 'IJMB Study Centres in Nigeria 2026/2027',
...
const jsonLd = {
  ...
  '@type': 'WebPage',
  name: 'IJMB Accredited Study Centres in Nigeria 2026/2027',
  url: 'https://www.ijmb.info/ijmb-centres-in-nigeria',
  description: 'Complete list of IJMB approved study centres across all 36 states of Nigeria for the 2026/2027 academic session.',
  breadcrumb: {
    '@type': 'BreadcrumbList',
    itemListElement: [
