...
export const metadata: Metadata = {
  ...
  description: `Register for IJMB ${YEAR} online. Complete your IJMB form, pay the ₦10,000 form fee, and gain direct entry into 200 level without UTME. Apply now.`,
  ...
  openGraph: {
    ...
    description: `Register for IJMB ${YEAR} and gain direct entry into 200 level without UTME. Form fee ₦10,000. Apply now.`,
  ...
  twitter: {
    ...
    description: 'Register for IJMB online. Direct entry 200 level without UTME. Form fee ₦10,000.',
